...
<template>
  <div class="py-24 flex flex-col items-center">
    ...
    <p class="w-11/12 md:w-1/2 mb-4 text-sm md:text-xl text-center text-gray-500">Kumpulan quote di dunia sebagai penyemangat dan nasihat. Dibuat untuk memeraiahkan Event Hacktoberfest 2021.</p>
    <div class="w-11/12 md:w-1/2 flex justify-center">
