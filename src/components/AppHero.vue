...
<template>
  <div class="py-12 flex flex-col items-center">
    ...
    <p class="w-11/12 md:w-1/2 mb-4 text-sm md:text-xl text-center text-gray-500">Kumpulan quote oleh orang-orang hebat di dunia sebagai penasehat dan penyemangat. Dibuat untuk memeriahkan event Hacktoberfest 2021.</p>
