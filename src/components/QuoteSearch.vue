...
.search-main--action {
  @apply flex absolute right-1 text-right;
}
.search-main--action .action-badge {
  @apply text-[11px] leading-[20px] py-0 px-[7px] inline-block mr-3 rounded-xl ring-1 text-purple-800 dark:text-purple-400 ring-purple-300 bg-purple-400 dark:bg-purple-100 bg-opacity-25 dark:bg-opacity-5;
}
.search-main--input {
