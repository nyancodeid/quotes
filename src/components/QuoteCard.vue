...
<template>
  <div class="w-full relative text-white overflow-hidden hover:overflow-visible flex hover:scale-105 duration-300">
    <div class="w-full flex flex-col transition ease-in-out transform hover:rotate-1 duration-500 rounded-3xl shadow-lg" :class="getGradientByIndex(quote.gradient_id)">
